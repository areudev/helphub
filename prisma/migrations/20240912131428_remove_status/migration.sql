...
INSERT INTO "new_Offer" ("announcementId", "createdAt", "id", "itemId", "latitude", "longitude", "notes", "quantity", "updatedAt", "userId") SELECT "announcementId", "createdAt", "id", "itemId", "latitude", "longitude", "notes", "quantity", "updatedAt", "userId" FROM "Offer";
DROP TABLE "Offer";
...
INSERT INTO "new_Request" ("createdAt", "id", "itemId", "latitude", "longitude", "notes", "numberOfPeople", "quantity", "updatedAt", "userId") SELECT "createdAt", "id", "itemId", "latitude", "longitude", "notes", "numberOfPeople", "quantity", "updatedAt", "userId" FROM "Request";
DROP TABLE "Request";
